...
export class Plan{
    ...
    addPlan(){
        if((<HTMLInputElement>document.getElementById('title')).value==""){
            alert('제목을 입력해주세요')
        } else if((<HTMLInputElement>document.getElementById('starttime')).value>"24" ||(<HTMLInputElement>document.getElementById('starttime')).value <"0" ||(<HTMLInputElement>document.getElementById('endtime')).value>"24" ||(<HTMLInputElement>document.getElementById('endtime')).value<"0")
